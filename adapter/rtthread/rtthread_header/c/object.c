...
#include <rthw.h>
 ...
 #endif
 #ifndef __on_pms_rt_object_attach_hook
     #define __on_pms_rt_object_attach_hook(obj)     __ON_HOOK_ARGS(pms_rt_object_attach_hook, (obj))
 #endif
 #ifndef __on_pms_rt_object_detach_hook
     #define __on_pms_rt_object_detach_hook(obj)     __ON_HOOK_ARGS(pms_rt_object_detach_hook, (obj))
 #endif
 ...
 // PMS hook
 static void (*pms_rt_object_attach_hook)(struct rt_object *object);
 static void (*pms_rt_object_detach_hook)(struct rt_object *object);
 ...
 void pms_rt_object_attach_sethook(void (*hook)(struct rt_object *object))
 {
     pms_rt_object_attach_hook = hook;
 }
 ...
 void pms_rt_object_detach_sethook(void (*hook)(struct rt_object *object))
 {
     pms_rt_object_detach_hook = hook;
 }
                     ...
                     const char               *name)
 {
             ...
             node  = node->next)
     {
         ...
         {
             RT_ASSERT_EXT(obj != object, "object[%s] already exist", object->name);
         }
     }
     /* leave critical */
     rt_exit_critical();
     ...
     RT_OBJECT_HOOK_CALL(pms_rt_object_attach_hook, (object));
 ...
 void rt_object_detach(rt_object_t object)
 {
     ...
     RT_OBJECT_HOOK_CALL(pms_rt_object_detach_hook, (object));
 ...
 rt_uint8_t rt_object_get_type(rt_object_t object)
 {
     ...
     return object->type & RT_OBJECT_MASK;
 }
 ...
 /**
  * @brief This function will set object name
  *
  * @param object is the specified object to be set name.
