...
#include <stdint.h>
 ...
 #define RT_SLIST_NEXT(n) ((n) ? (n)->next : NULL)
 #define rt_slist_for_each_safe(pos, n, head) \
     for (pos = RT_SLIST_NEXT(head), n = RT_SLIST_NEXT(pos); pos != RT_NULL; pos = n, n = RT_SLIST_NEXT(pos))
 /**
 ...
 #if defined(__CC_ARM)
 static __inline __asm uint32_t get_MSP(void)
 {
     mrs r0, msp bx lr
 }
 static __inline __asm uint32_t get_PSP(void)
 {
     mrs r0, psp bx lr
 }
 static __inline __asm uint32_t get_SP(void)
 {
     mov r0, sp bx lr
 }
 static __inline __asm uint32_t get_PRIMASK(void)
 {
     mov r0, primask bx lr
 }
 static __inline __asm uint32_t  get_BASEPRI(void)
 {
   mov r0, basepri bx lr
 }
 #elif defined(__clang__)
 __attribute__((always_inline)) static __inline uint32_t get_MSP(void)
 {
     uint32_t result;
     __asm volatile("mrs %0, msp" : "=r"(result));
     return (result);
 }
 __attribute__((always_inline)) static __inline uint32_t get_PSP(void)
 {
     uint32_t result;
     __asm volatile("mrs %0, psp" : "=r"(result));
     return (result);
 }
 __attribute__((always_inline)) static __inline uint32_t get_SP(void)
 {
     uint32_t result;
     __asm volatile("mov %0, sp" : "=r"(result));
     return (result);
 }
 __attribute__((always_inline)) static __inline uint32_t get_IPSR(void)
 {
     uint32_t result;
 ...
 __attribute__((always_inline)) static __inline uint32_t get_APSR(void)
 {
   uint32_t result;
 ...
 __attribute__((always_inline)) static __inline uint32_t get_xPSR(void)
 {
   uint32_t result;
 ...
 __attribute__((always_inline)) static __inline uint32_t get_PRIMASK(void)
 {
     uint32_t result;
     __asm volatile("mrs %0, primask" : "=r"(result));
     return (result);
 }
 __attribute__((always_inline)) static __inline uint32_t get_BASEPRI(void)
 {
     uint32_t result;
 ...
 __attribute__((always_inline)) static inline uint32_t get_xPSR(void)
 {
     uint32_t result;
