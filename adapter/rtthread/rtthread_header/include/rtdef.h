 ...
 */
 ...
 enum rt_object_class_type
 {
     ...
     RT_Object_Class_PThread       = 0x40,      /**< The object is a pthread object. */
     RT_Object_Class_Static        = 0x80       /**< The object is a static object. */
 };
 #define RT_OBJECT_MASK 0x3F
 /**
 ...
 #ifdef RT_TIMER_SOFT_LPTMR
 #define RT_TIMER_FLAG_REGULAR_TIMER     0x0             /**< regular timer */
 #define RT_TIMER_FLAG_LOW_POWER_TIMER   0x8             /**< low power timer */
 #endif
 ...
 #ifdef RT_TIMER_SOFT_LPTMR
 #define RT_TIMER_CTRL_SET_LPTIMER       0x6             /**< change timer to lowpower timer */
 #define RT_TIMER_CTRL_SET_RGTIMER       0x7             /**< change timer to regular timer */
 #endif
 ...
 struct rt_thread
 {
     ...
     void *pms_data;                                   /**< private pms data beyond this thread */
 };
 typedef struct rt_thread *rt_thread_t;
 
 /**
  * Thread monitor: cpu usage, mem usage etc.
  */
 #ifdef RT_USING_THREAD_MONITOR
 ...
 typedef rt_uint64_t rt_cpu_usage_cycle_t;
 
 /**
  * Number of historical running time records
  */
 #define RT_CPU_USAGE_HISTORY_RECORD_NUM  11
 
 /**
  * Multiple of current cpu usage precision change to percent.
  */
 #define RT_CPU_USAGE_PRECISION_PERCENT  (RT_CPU_USAGE_PRECISION_MULTIPLE / 100)
 
 #if (RT_CPU_USAGE_PRECISION_PERCENT != 100 &&  \
      RT_CPU_USAGE_PRECISION_PERCENT != 10  &&  \
      RT_CPU_USAGE_PRECISION_PERCENT != 1)
 #error "cpu usage precision precent not support, please modify macro RT_CPU_USAGE_PRECISION_MULTIPLE"
 #endif
 
 /**
  * cpu usage mode: [1 unit], [10 unit], [from system startup to now]
  */
 enum rt_cpu_usage_mode
 {
     RT_CPU_USAGE_MODE_LAST_1_UNIT = 0,                  /**< get cpu usage in the last 1 unit */
     RT_CPU_USAGE_MODE_LAST_10_UNIT = 1,                 /**< get cpu usage in the last 10 unit */
     RT_CPU_USAGE_MODE_ALL = 2,                          /**< get cpu usage from system startup to now */
 
     RT_CPU_USAGE_MODE_MAX,                              /**< invalid, indicate mode max */
 };
 ...
 struct rt_cpu_usage
 {
     rt_list_t             usage_list;                   /**< cpu usage struct list */
     struct rt_thread     *thread;                       /**< pointer to thread */
 
     rt_cpu_usage_cycle_t  start_cycle;                  /**< start running cycle */
     rt_cpu_usage_cycle_t  all_cycle;                    /**< total running cycle */
                                                         /**< history running cycle, the last one saves zero */
     rt_cpu_usage_cycle_t  history_cycle[RT_CPU_USAGE_HISTORY_RECORD_NUM + 1];
 };
 #endif
 ...
 #ifdef RT_MEMHEAP_BEST_FIT
     rt_uint32_t             item_size;                  /**< size of memheap item */
 #endif
 ...
 struct rt_mempool
 {
     ...
     rt_list_t        suspend_thread;                    /**< threads pended on this resource */
 #ifdef RT_MEMPOOL_TAIL_INSERT
     rt_uint8_t      *tail_block_ptr;                    /**< pointer of tail block */
 #endif
 
 #ifdef RT_MEMPOOL_USAGE_STATISTICS
     rt_size_t        max_alloc_count;                   /**< indicates Maximum usage */
     rt_size_t        alloc_times;                       /**< indicates frenquency fo use */
     rt_size_t        free_times;                        /**< indicates frenquency fo use */
 #endif
 };
 ...
 #ifdef RT_USING_PMEM
 /**
  * Base structure of pmem pool config table object
  */
 struct rt_pmem_tab
 {
     rt_uint32_t          blk_size;                      /**< block size configuration of a pmem pool */
     rt_uint32_t          blk_cnt;                       /**< block count configuration of a pmem pool */
     rt_uint32_t          min_mem;                       /**< The smallest size configuration that a block can be allocated */
 };
 
 /**
  * Base structure of pmem pool object
  */
 struct rt_pmem_pool
 {
     rt_uint32_t          min_mem;                       /**< minimum size of a block that can be allocated */
     struct rt_mempool    mp;                            /**< a mempool object of pmem */
 };
 
 enum rt_memory_manage_mode
 {
     RT_MANAGE_MODE_MEMHEAP = 0,                           /**< memheap */
     RT_MANAGE_MODE_TLSF,                                  /**< tlsf */
 };
 
 #ifdef MEMPOOL_USE_TLSF
 typedef void* tlsf_t;
 #endif
 /**
  * Base structure of pmem (Combination of multiple memory pools and single memory heap) object
  */
 struct rt_pmem
 {
 #ifdef MEMPOOL_USE_TLSF
     tlsf_t               tlsf_heap;                          /**< manage memheap of pmem */
 #endif
     struct rt_memheap    heap;                          /**< manage memheap of pmem */
     void                *heap_start;                    /**< memheap start addr of pmem */
     void                *pool_start;                    /**< mempool start addr of pmem */
     rt_size_t            mp_cnt;                        /**< mempool count of pmem */
     struct rt_pmem_pool *pmp;                           /**< management structure of multiple mempools in pmem */
 };
 typedef struct rt_pmem *rt_pmem_t;
 #endif
 ...
 enum rt_device_class_type
 {
     ...
     RT_Device_Class_DSIBUS,                             /**< DSI bus device */
     RT_Device_Class_DISPBUS,                            /**< DISP bus device */
     RT_Device_Class_MMU,                                /**< MMU device */
     RT_Device_Class_LCDC,                               /**< LCDC device */
     ...
     RT_Device_Class_Crown,                              /**< Crown device */
     RT_Device_Class_PHY,                                /**< PHY device */
     RT_Device_Class_Charger,                            /**< Charger device */
     RT_Device_Class_Gauge,                              /**< Fuel Gauge device */
     RT_Device_Class_Vibrator,                           /**< Vibrator deivce */
     RT_Device_Class_SmartPA,                            /**< SmartPA deivce */
     RT_Device_Class_GNSS,                               /**< GPS deivce */
     RT_Device_Class_Battery,                            /**< Battery deivce */
     RT_Device_Class_GPIO,                               /**< GPIO deivce */
 ...
 #define RT_DEVICE_CTRL_RTC_GET_TIME_MS  0x14            /**< get millisecond time */
 #define RT_DEVICE_CTRL_RTC_UPDATE_TIME  0x15            /**< sys startup update time */
 #define RT_DEVICE_CTRL_RTC_SAVE_TIME    0x16            /**< save time when reboot or shutdown */
 #define RT_DEVICE_CTRL_RTC_CLEAR_ALARM  0x17            /**< clear rtc alarm */
 #define RT_DEVICE_CTRL_RTC_WAKEUP_ENABLE    0x18        /**< enable rtc wakeup */
 #define RT_DEVICE_CTRL_RTC_WAKEUP_DISABLE   0x19        /**< disable rtc wakeup */
 ...
 struct rt_device_blk_geometry
 {
     ...
     rt_uint32_t sector_pos;                             /**< position of sector */
 };
 ...
 #define RTGRAPHIC_CTRL_GET_BRIGHTNESS   6
 #define RTGRAPHIC_CTRL_SET_BRIGHTNESS   7
 #define RTGRAPHIC_CTRL_AOD_ENTER        8
 #define RTGRAPHIC_CTRL_AOD_EXIT         9
 #define RTGRAPHIC_CTRL_SET_DIMMING      10
 #define RTGRAPHIC_CTRL_HBM_ENTER        11
 #define RTGRAPHIC_CTRL_HBM_EXIT         12
 #define RTGRAPHIC_CTRL_GET_FB_INFO      13
 ...
 struct rt_device_graphic_info
 {
     ...
     rt_uint16_t buffer_age;
 
     rt_uint8_t *framebuffer;                            /**< frame buffer on show, generally for dsi*/
     rt_uint8_t *fb_rendering;                           /**< frame buffer on rendering,  generally for gui engine*/
     rt_uint8_t  screen_shape;                           /**< screen shape */
 };
 ...
 struct rt_device_rect_info
 {
     ...
     rt_uint8_t *fb;                                 /* gpu draw framebuff */
     rt_uint8_t gpu_flag;                                 /* lcd update sync flag */
     rt_uint64_t count;
 };
