 ...
 */
 ...
 #else
 rt_base_t rt_hw_global_interrupt_disable();
 void rt_hw_global_interrupt_enable(rt_base_t level);
 rt_base_t rt_hw_interrupt_disable_ext(rt_base_t level);
 void rt_hw_interrupt_enable_ext(rt_base_t level);
 rt_base_t rt_hw_interrupt_disable(void);
 void rt_hw_interrupt_enable(rt_base_t level);
 #if defined(__GNUC__)
 rt_uint32_t rt_get_interrupt_disable_caller(void);
 #endif
