...
#if (defined (RTE_PPC_SSE300_MAIN0) && (RTE_PPC_SSE300_MAIN0 == 1)) || \
    (defined (RTE_PPC_SSE300_MAIN_EXP0) && (RTE_PPC_SSE300_MAIN_EXP0 == 1)) || \
    (defined (RTE_PPC_SSE300_MAIN_EXP1) && (RTE_PPC_SSE300_MAIN_EXP1 == 1)) || \
    (defined (RTE_PPC_SSE300_PERIPH0) && (RTE_PPC_SSE300_PERIPH0 == 1)) || \
    (defined (RTE_PPC_SSE300_PERIPH1) && (RTE_PPC_SSE300_PERIPH1 == 1)) || \
    (defined (RTE_PPC_SSE300_PERIPH_EXP0) && (RTE_PPC_SSE300_PERIPH_EXP0 == 1)) || \
    (defined (RTE_PPC_SSE300_PERIPH_EXP1) && (RTE_PPC_SSE300_PERIPH_EXP1 == 1)) || \
    (defined (RTE_PPC_SSE300_PERIPH_EXP2) && (RTE_PPC_SSE300_PERIPH_EXP2 == 1))
...
static ARM_DRIVER_VERSION PPC_SSE300_GetVersion(void)
{
...
#if (defined (RTE_PPC_SSE300_MAIN0_EXP0) && (RTE_PPC_SSE300_MAIN0_EXP0 == 1))
...
#if (defined (RTE_PPC_SSE300_MAIN0_EXP1) && (RTE_PPC_SSE300_MAIN0_EXP1 == 1))
...
#if (defined (RTE_PPC_SSE300_MAIN_EXP2) && (RTE_PPC_SSE300_MAIN_EXP2 == 1))
...
#if (defined (RTE_PPC_SSE300_MAIN_EXP3) && (RTE_PPC_SSE300_MAIN_EXP3 == 1))
...
#if (defined (RTE_PPC_SSE300_PERIPH0) && (RTE_PPC_SSE300_PERIPH0 == 1))
...
#if (defined (RTE_PPC_SSE300_PERIPH1) && (RTE_PPC_SSE300_PERIPH1 == 1))
...
#if (defined (RTE_PPC_SSE300_PERIPH_EXP0) && (RTE_PPC_SSE300_PERIPH_EXP0 == 1))
...
#if (defined (RTE_PPC_SSE300_PERIPH_EXP1) && (RTE_PPC_SSE300_PERIPH_EXP1 == 1))
...
#if (defined (RTE_PPC_SSE300_PERIPH_EXP2) && (RTE_PPC_SSE300_PERIPH_EXP2 == 1))
...
#if (defined (RTE_PPC_SSE300_PERIPH_EXP3) && (RTE_PPC_SSE300_PERIPH_EXP3 == 1))
