 ...
 *        Features of driver:
 *          1. Initialize PPC device
 *          2. Configure privilege/security attribute
 *          3. Check the peripheral's privilege attribute
 *          4. Check if peripheral is secure/non-secure
 *          5. Enable/Disable/Clear PPC interrupt
 *          6. Get PPC interrupt state
 */
