...
impl<'a, T: Zero> NullTerminated<'a, T> {
...
impl<'a, T: Zero> FusedIterator for NullTerminated<'a, T> {}
...
impl<'a, T: Zero> NullTerminatedInclusive<'a, T> {
    /// Constructs a new iterator, starting at `ptr`, yielding elements of
...
impl<'a, T: Zero> FusedIterator for NullTerminatedInclusive<'a, T> {}
