...
#[no_mangle]
pub unsafe extern "C" fn rt_mb_init (mb : rt_mailbox_t , name : * const core :: ffi :: c_char , msgpool : * mut core :: ffi :: c_void , size : rt_size_t , flag : rt_uint8_t) -> rt_err_t {
    assert!(mb != null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rt_mb_create (name : * const core :: ffi :: c_char , size : rt_size_t , flag : rt_uint8_t) -> rt_mailbox_t {
...
unsafe extern "C" fn _rt_mb_send_wait (mb : rt_mailbox_t , value : rt_ubase_t , timeout : rt_int32_t, suspend_flag : i32) -> rt_err_t {
    ...
    while (*mb).entry == (*mb).size {
        ...
        let ret = _rt_ipc_list_suspend(&mut  (*mb).suspend_sender_thread, thread, (*mb).parent.parent.flag, suspend_flag);
...
#[cfg(feature = "RT_USING_MAILBOX")]
#[no_mangle]
pub unsafe extern "C" fn rt_mb_send_wait (mb : rt_mailbox_t , value : rt_ubase_t , timeout : rt_int32_t) -> rt_err_t {
    _rt_mb_send_wait(mb, value, timeout, RT_UNINTERRUPTIBLE as i32)
}

#[cfg(feature = "RT_USING_MAILBOX")]
#[no_mangle]
pub unsafe extern "C" fn rt_mb_send_wait_interruptible (mb : rt_mailbox_t , value : rt_ubase_t , timeout : rt_int32_t) -> rt_err_t {
    _rt_mb_send_wait(mb, value, timeout, RT_INTERRUPTIBLE as i32)
}

#[cfg(feature = "RT_USING_MAILBOX")]
#[no_mangle]
pub unsafe extern "C" fn rt_mb_send_wait_killable (mb : rt_mailbox_t , value : rt_ubase_t , timeout : rt_int32_t) -> rt_err_t {
...
unsafe extern "C" fn _rt_mb_recv (mb : rt_mailbox_t , value : * mut core::ffi::c_ulong , timeout : rt_int32_t, suspend_flag: i32) -> rt_err_t {
    ...
    while (*mb).entry == 0 {
        ...
        let ret = _rt_ipc_list_suspend(&mut (*mb).parent.suspend_thread, thread, (*mb).parent.parent.flag, suspend_flag);
        if ret != RT_EOK as rt_err_t {
            rt_hw_interrupt_enable(level);
            return ret;
        }
...
#[cfg(feature = "RT_USING_MAILBOX")]
#[no_mangle]
pub unsafe extern "C" fn rt_mb_recv (mb : rt_mailbox_t , value : * mut core::ffi::c_ulong , timeout : rt_int32_t) -> rt_err_t {
    return _rt_mb_recv(mb, value, timeout, RT_UNINTERRUPTIBLE as i32)
}

#[cfg(feature = "RT_USING_MAILBOX")]
#[no_mangle]
pub unsafe extern "C" fn rt_mb_recv_interruptible (mb : rt_mailbox_t , value : * mut core::ffi::c_ulong , timeout : rt_int32_t) -> rt_err_t {
    return _rt_mb_recv(mb, value, timeout, RT_INTERRUPTIBLE as i32);
}

#[cfg(feature = "RT_USING_MAILBOX")]
#[no_mangle]
pub unsafe extern "C" fn rt_mb_recv_killable (mb : rt_mailbox_t , value : * mut core::ffi::c_ulong , timeout : rt_int32_t) -> rt_err_t {
...
impl MailBox {
    pub fn new(name: &str, size: usize) -> Result<Self, Error> {
        let result = unsafe { rt_mb_create(name.as_ptr() as *const c_char, size as rt_size_t, RT_IPC_FLAG_PRIO as u8) };
        if result == RT_NULL as rt_mailbox_t{
            Err(Error::from_errno(RT_ERROR as i32))
        } else {
            Ok( Self {mb_ptr: result, _pin: PhantomPinned {} })
        }
    }
