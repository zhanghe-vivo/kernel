...
#[cfg(all(not(feature = "RT_MAIN_THREAD_STACK_SIZE"), feature = "RT_USING_USER_MAIN"))]
pub const RT_MAIN_THREAD_STACK_SIZE :u32 = 2048;

#[cfg(all(not(feature = "RT_MAIN_THREAD_PRIORITY"), feature = "RT_USING_USER_MAIN"))]
...
#[cfg(all(feature = "RT_USING_COMPONENTS_INIT", feature = "_MSC_VER", feature = "RT_DEBUGING_INIT"))]
#[repr(C)]
struct RtInitDesc {
...
#[cfg(all(feature = "RT_USING_COMPONENTS_INIT", feature = "_MSC_VER", not(feature = "RT_DEBUGING_INIT" )))]
#[repr(C)]
struct RtInitDesc {
    level: *const core::ffi::c_char,
    fn_ptr: InitFn,
...
#[cfg(all(feature = "RT_USING_COMPONENTS_INIT", feature = "RT_DEBUGING_INIT", not(feature = "_MSC_VER" )))]
#[repr(C)]
struct RtInitDesc {
    fn_name: *const core::ffi::c_char,
    fn_ptr: InitFn,
...
#[cfg(all(feature = "RT_USING_COMPONENTS_INIT", not(feature = "RT_DEBUGING_INIT"), not(feature = "_MSC_VER" )))]
macro_rules! init_export {
    ($func: ident, $level: expr) => {
        paste! {
            static [<"rti" $level>]: &str = concat!(".rti_fn.", $level);
...
pub extern "C" fn rt_application_init() {
    ...
    unsafe {
       ...
       {
            tid = rt_thread_create(c_str!("main").as_ptr() as *const i8, core::option::Option::Some(main_thread_entry), 
                RT_NULL as *mut core::ffi::c_void, RT_MAIN_THREAD_STACK_SIZE, RT_MAIN_THREAD_PRIORITY as u8, 20 as u32);
       }
       #[cfg(not(feature = "RT_USING_HEAP"))]
       {
            tid = &MAIN_THREAD;
            let result:rt_err_t = rt_thread_init(tid, c_str!("main").as_ptr() as *const i8, core::option::Option::Some(main_thread_entry), RT_NULL as *mut core::ffi::c_void,
                MAIN_THREAD_STACK.as_mut_ptr(), MAIN_THREAD_STACK.len(), RT_MAIN_THREAD_PRIORITY as u8, 20 as u32);
       }
