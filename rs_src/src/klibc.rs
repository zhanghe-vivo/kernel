use core::{
    ffi::{c_void, c_int, c_size_t, c_char},
    ptr,
...
#[linkage = "weak"]
#[no_mangle]
pub unsafe extern "C" fn rt_memset(
    s: *mut c_void,
    c: c_int,
    count: c_size_t
) -> *mut c_void {
...
#[cfg(not(feature = "RT_KSERVICE_USING_STDLIB_MEMORY"))]
#[no_mangle]
pub unsafe extern "C" fn rt_memcmp(
    cs: *const c_void,
    ct: *const c_void,
    n: c_size_t
) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt_strstr(
    cs: *const c_char,
    ct: *const c_char
) -> *mut c_char {
    if *ct.offset(0) == 0 {
...
#[cfg(not(feature = "RT_KSERVICE_USING_STDLIB"))]
#[no_mangle]
pub unsafe extern "C" fn rt_strcasecmp(
    s1: *const c_char,
    s2: *const c_char
) -> c_int {
    let mut i = 0;
...
#[cfg(not(feature = "RT_KSERVICE_USING_STDLIB"))]
#[no_mangle]
pub unsafe extern "C" fn rt_strcpy(
    dst: *mut c_char,
    src: *const c_char
) -> *mut c_char {
    let mut i = 0;
...
#[cfg(not(feature = "RT_KSERVICE_USING_STDLIB"))]
#[no_mangle]
pub unsafe extern "C" fn rt_strncmp(
    cs: *const c_char,
    ct: *const c_char,
    n: c_size_t
) -> c_int {
...
#[cfg(not(feature = "RT_KSERVICE_USING_STDLIB"))]
#[no_mangle]
pub unsafe extern "C" fn rt_strcmp(
    cs: *const c_char,
    ct: *const c_char
) -> c_int {
    for i in 0.. {
...
#[no_mangle]
pub unsafe extern "C" fn rt_strnlen(
    cs: *const c_char,
    maxlen: c_size_t
) -> c_size_t {
	let mut len = 0;
...
mod tests {
    ...
    fn test_memset() {
        ...
        unsafe { rt_memset(array.as_mut_ptr(), b'a', 2);}
